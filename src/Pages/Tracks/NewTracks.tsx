...
function NewTracks() {
  ...
  return (
    <div id="tracks" className="flex flex-col items-center justify-center">
      <HeaderText text="TRACKS" />

      <div className={styles.slider}>
        <div className={styles.cardsContainer}>
          {trackData.map((track: TrackDataTypes) => {
            {
              /* (track: TrackDataTypes, index: number) */
            }
            // const offset = index - active;

            // Determine the visual position of the cards
            const styleClass = styles.active; // Default style for hidden cards
